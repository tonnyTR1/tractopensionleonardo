            ...
            <div class="col-lg-6 d-flex align-items-center justify-content-center">
              <div class="auth-form-transparent text-left p-3">
                ...
                <form class="pt-3">
                  ...
                  <div class="my-3">
                    <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="?menu=panel">LOGIN</a>
                  </div>
                  ...
                  <div class="text-center mt-4 font-weight-light"> Don't have an account? <a href="?menu=registro" class="text-primary">Crear</a>
                  </div>
                </form>
              </div>
            </div>
